...
Usage (single text):
    python src/inference.py --model_path models/ViHSD_processed_visobert_reproduction --text "Đây là bình luận tệ"

Usage (HuggingFace model):
    python src/inference.py --model_name tarudesu/ViSoBERT-HSD --text "Đây là bình luận tệ"
...
def main():
    ...
    # CSV inference
    if args.input_csv:
        print(f"📚 Loading texts from {args.input_csv}...")
